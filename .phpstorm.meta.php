...
namespace PHPSTORM_META {
    ...
    */
    ...
    override(\config(), map([
            ...
            'filesystems.links./home/h_samer97/hospital/public/storage' => 'string',
...
'auth.guards.web.provider','auth.guards.admins.driver','auth.guards.admins.provider','auth.guards.sanctum.driver','auth.guards.sanctum.provider',
'auth.providers.users.driver','auth.providers.users.model','auth.providers.admins.driver','auth.providers.admins.model','auth.passwords.users.provider',
...
'auth.passwords.admins.expire','auth.passwords.admins.throttle','auth.password_timeout','cache.default','cache.stores.array.driver',
...
'filesystems.disks.s3.throw','filesystems.disks.s3.report','filesystems.links./home/h_samer97/hospital/public/storage','laravellocalization.supportedLocales.en.name','laravellocalization.supportedLocales.en.script',
...
'laravellocalization.supportedLocales.es.regional','laravellocalization.useAcceptLanguageHeader','laravellocalization.hideDefaultLocaleInURL','laravellocalization.localesOrder','laravellocalization.localesMapping',
...
'session.partitioned','session.serialization','inertia.ssr.enabled','inertia.ssr.url','inertia.ssr.ensure_bundle_exists',
